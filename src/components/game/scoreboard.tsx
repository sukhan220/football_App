...
//         dots.push(
//           <View key={i} style={[styles.dot, styles.greenDot]}>
//             <Text style={styles.dotIcon}>✓</Text>
//           </View>
//         );
//       } else if (shot === 'MISS' || shot === 'SAVED' || shot === 'POST_HIT' || shot === false) {
//         dots.push(
//           <View key={i} style={[styles.dot, styles.redDot]}>
//             <Text style={styles.dotIcon}>✕</Text>
//           </View>
//         );
//       } else {
...
//           <View style={styles.dotsRow}>{renderShotDots(debugInfo?.p1Shots)}</View>
//         </View>
...
//           <View style={styles.dotsRow}>{renderShotDots(debugInfo?.p2Shots)}</View>
//         </View>
//       </View>

//       <View style={styles.turnBadge}>
//         <Text style={styles.turnBadgeText}>
//           🎯 Turn: <Text style={{ color: '#00ffcc' }}>{debugInfo?.currentShooter || 'P1'}</Text> | 🧤 Keeper:{' '}
//           <Text style={{ color: '#ff007f' }}>{debugInfo?.currentKeeper || 'AI'}</Text>
//         </Text>
//       </View>
//     </View>
//   );
