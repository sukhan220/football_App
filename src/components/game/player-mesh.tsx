...
//   const socksMat = <meshStandardMaterial color="#ffffff" roughness={0.4} />; // 🧦 সাদা মোজা
//   const bootMat = <meshStandardMaterial color="#ff3300" roughness={0.2} />; // 👟 চটকদার লাল ফুটবল বুট
